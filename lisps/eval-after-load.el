...
;; by use 'eal-eval-by-modes', 'eal-eval-by-maps', and 'define-key'
;; move convient use function 'eal-define-key', 'eal-define-keys'
;; 'eal-define-keys-commonly'.
;; For more details, see artical http://emacser.com/eval-after-load.htm
