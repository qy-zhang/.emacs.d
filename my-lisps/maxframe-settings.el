;;; maxframe-settings --- maximize emacs
;;; Commentary:
;; -*- Emacs-Lisp -*-
...
(defun restore-frame ()
  "Restore a maximized frame.  See `maximize-frame'."
  (interactive)
...
; (define-prefix-command 'm-spc-map)      ;设置 M-SPC 为按键前缀
...
(global-set-key [f11] 'toggle-maximize-frame)

(provide 'maxframe-settings)
;;; maxframe-settings.el ends here
